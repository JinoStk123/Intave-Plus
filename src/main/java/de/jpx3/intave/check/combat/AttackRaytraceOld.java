...
import static de.jpx3.intave.check.combat.AttackRaytraceOld.AttackRaytraceResult.of;
...
@Relocate
public final class AttackRaytraceOld extends MetaCheck<AttackRaytraceOld.AttackRaytraceMeta> {
...
//  private final static boolean HAS_MYTHIC_MOBS = Bukkit.getPluginManager().isPluginEnabled("MythicMobs");
  ...
  public AttackRaytraceOld(IntavePlugin plugin) {
...
//    }
    ...
    Violation violation = Violation.builderFor(AttackRaytraceOld.class)
